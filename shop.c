...
{ 
	...
	if (selshop == 5) { system("cls"); eating(); }
}
...
void cat2shop() {
	...
	if (selMenu == 1) { system("cls"); cat2hat_shop(); }
	if (selMenu == 2) { system("cls"); cat2glasses_shop(); }
...
void cat2hat_shop() {
	...
	printf("                                           ▲  원하는 메뉴를 선택하세요 ▲ ");
	scanf("%d", &selHat);
	if (selHat == 1) { system("cls"); cat2magic_hat(); }
	if (selHat == 2) { system("cls"); cat2crown(); }
	if (selHat == 3) { system("cls"); shop(); }
...
void cat3shop() {
	...
	if (selMenu == 1) { system("cls"); cat3hat_shop(); }
	if (selMenu == 2) { system("cls"); cat3glasses_shop(); }
...
void cat3hat_shop() {
	...
	printf("                                           ▲  원하는 메뉴를 선택하세요 ▲ ");
	scanf("%d", &selHat);
	if (selHat == 1) { system("cls"); cat3magic_hat(); }
	if (selHat == 2) { system("cls"); cat3crown(); }
	if (selHat == 3) { system("cls"); shop(); }
